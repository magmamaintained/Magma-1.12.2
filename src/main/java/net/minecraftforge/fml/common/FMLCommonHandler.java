...
//        MinecraftForge.registerCrashCallable();
    ...
    public boolean handleServerHandshake(C00Handshake packet, NetworkManager manager)
    {
        ...
        {
            TextComponentString text = new TextComponentString(ChatColor.translateAlternateColorCodes('&', MagmaConfig.instance.serverStillStartingMessage.getValues())); // Magma
